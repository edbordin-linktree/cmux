...
var commands = []commandSpec{
	...
	{name: "new-pane", proto: protoV2, v2Method: "pane.create", flagKeys: []string{"workspace", "surface", "direction", "type", "url", "command", "title", "focus"}, defaultParams: map[string]any{"direction": "right"}},
	{name: "new-surface", proto: protoV2, v2Method: "surface.create", flagKeys: []string{"workspace", "pane", "type", "url", "command", "title", "focus"}},
	{name: "new-split", proto: protoV2, v2Method: "surface.split", flagKeys: []string{"workspace", "surface", "direction", "type", "url", "command", "title", "focus"}},
